...
export default function BillingPage() {
  ...
  // Marketing /pricing tiles deep-link here with ?tier=pro&interval=annual
  ...
  useEffect(() => {
    ...
    // landlord/agent session by the time this effect runs, so the manual
    // session check that the old top-level /billing page used is gone.
    void load();
  }, [load]);

...
/**
 * Sticky header for the /partner/* sub-pages. Adapted from
 * components/app/Topbar.tsx's AppTopbar, but stripped of the landlord-app
 * chrome (sidebar toggle, account menu, "Refer & earn" link, billing
 * sign-out) that doesn't apply inside the partner shell. Kept local to this
 * file, it's the same shape copied into partner/kyc/page.tsx.
 */
  ...
  return (
    <>
      <PartnerSectionHeader
        title="Bank accounts"
        subtitle="Where your partner earnings withdrawals will land"
        backHref="/partner"
        actions={
          !adding && (
            <button
      ...
      <PageContainer>
        ...
        {accounts.isLoading ? (
          ...
          <EmptyState
            ...
            body="Add a Nigerian bank account so we can pay out your partner earnings."
          />
        ) : (
          <Card className="divide-y divide-foundation-700/10">
            {accounts.data!.map((a) => (
